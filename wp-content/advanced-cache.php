...
// WordPress 4.7 changes how filters are hooked. Since WordPress 4.6 add_filter can be used in advanced-cache.php.
// Previous behaviour is kept for backwards compatability with WP < 4.6
