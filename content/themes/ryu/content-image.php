...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-wrap wrap clear">
		...
		<a class="entry-format-badge theme-genericon" href="<?php echo esc_url( get_post_format_link( 'image' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'ryu' ), get_post_format_string( 'image' ) ) ); ?>"><span class="screen-reader-text"><?php echo get_post_format_string( 'image' ); ?></span></a>
	</div><!-- .entry-wrap -->
</article><!-- #post-## -->